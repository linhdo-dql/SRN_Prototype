...
<<<<<<<< HEAD:Assets/CorgiEngineHandcraftedArt/CorgiEngine/ThirdParty/MoreMountains/MMTools/Editor/MMMovement/MMPathMovement/MMPathMovementEditor.cs
				var fmh_65_57_638083744690817120 = Quaternion.identity; Vector3 newPoint = Handles.FreeMoveHandle(oldPoint,.5f,new Vector3(.25f,.25f,.25f),Handles.CircleHandleCap);
========
				var fmh_65_57_638082009345085250 = Quaternion.identity; Vector3 newPoint = Handles.FreeMoveHandle(oldPoint,.5f,new Vector3(.25f,.25f,.25f),Handles.CircleHandleCap);
>>>>>>>> 892d77b46b203896beb35757b7e6ffd7ccffc764:Assets/ThirdParty/CorgiEngine/ThirdParty/MoreMountains/MMTools/Editor/MMMovement/MMPathMovement/MMPathMovementEditor.cs
