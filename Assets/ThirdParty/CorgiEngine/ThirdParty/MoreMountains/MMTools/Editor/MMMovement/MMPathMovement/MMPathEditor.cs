...
<<<<<<<< HEAD:Assets/CorgiEngineHandcraftedArt/CorgiEngine/ThirdParty/MoreMountains/MMTools/Editor/MMMovement/MMPathMovement/MMPathEditor.cs
				var fmh_49_57_638083744690673680 = Quaternion.identity; Vector3 newPoint = Handles.FreeMoveHandle(oldPoint,.5f,new Vector3(.25f,.25f,.25f),Handles.CircleHandleCap);
========
				var fmh_49_57_638082009345167025 = Quaternion.identity; Vector3 newPoint = Handles.FreeMoveHandle(oldPoint,.5f,new Vector3(.25f,.25f,.25f),Handles.CircleHandleCap);
>>>>>>>> 892d77b46b203896beb35757b7e6ffd7ccffc764:Assets/ThirdParty/CorgiEngine/ThirdParty/MoreMountains/MMTools/Editor/MMMovement/MMPathMovement/MMPathEditor.cs
